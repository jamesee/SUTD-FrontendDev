...
function CareerForm(props) {
  ...
  //   e.preventDefault();
  //   props.addTask(`Hello ${jobTitle}!`);
  // }

  // function handleChange(e) {
  //   setJob({title: e.target.value});
  // }
  ...
  const handleSubmit = (e) => {
    ...
    if (!job) return;
    props.addJobs({...job, headcount: value});
    alert(`
            title : ${job.title} \n
            level : ${job.level} \n
            dept  : ${job.department} \n
                ...
                <div class="space-y-5">
                  <div class="lg:grid lg:grid-cols-3 lg:gap-4 lg:items-start">
                    ...
                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                      <input type="text" name="job-title" id="job-title" required="" class="
                        block
                        w-full
                        shadow-sm
                        sm:text-sm
                  ...
                  <div class="lg:grid lg:grid-cols-3 lg:gap-4 lg:items-start">
                    ...
                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                      <select id="job-level" name="job-level" required="" class="
                        block
                        w-full
                        pl-3
                        pr-10
                  ...
                  <div class="lg:grid lg:grid-cols-3 lg:gap-4 lg:items-start">
                    ...
                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                      <input type="text" name="job-department" id="job-department" required="" placeholder="e.g. Engineering" class="
                        block
                        w-full
                        shadow-sm
                        sm:text-sm
                  ...
                  <div class="lg:grid lg:grid-cols-3 lg:gap-4 lg:items-start">
                    ...
                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                      <textarea id="job-summary" name="job-summary" rows="4" required="" class="
                        block
                        w-full
                        shadow-sm
                        sm:text-sm
                      ...
                      onchange = {e => {
                        ...
                        setJob({...job, summary: e.target.value})
                      }}
                      ></textarea>
                    </div>
                  </div>
...
export const Career = () => {
  ...
  function addTask(job) {
    alert(`${job.title} in ${job.department}`);
  }

  return (
    <main class="bg-gray-50">
      <CareerForm addTask={addTask} addJobs={addJobs}/>
